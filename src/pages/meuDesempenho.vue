<template lang="pug">
  v-container(class="d-flex flex-column align-center justify-center ma-0 pa-0" style="height: 95vh;")  
    v-card(class="pa-0 d-flex flex-column" elevation="3" style="width: 900px; max-width: 90%; min-height: 450px;")
