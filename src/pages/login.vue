  ...
  <v-container class="d-flex align-center justify-center ma-0 pa-0" style="height: 100vh;">
    <v-card class="pa-10" elevation="3" style="width: 700px; max-width: 90%; height: 600px;">
      ...
      <v-row class="mb-5" justify="center" align="center">
        ...
        <v-col>
          <v-text-field label="Login" v-model="loginData.email" outlined clearable
      ...
      <v-row class="mb-6" justify="center" align="center">
        ...
        <v-col>
          <v-text-field type="password" label="Senha" v-model="loginData.password" outlined clearable
            :rules="[rules.required]" class="w-100"
            :style="{ backgroundColor: '#1E3A8A', color: 'white' }"></v-text-field>
        </v-col>
      ...
      <v-row justify="space-between" class="mt-4">
        <v-col>
          <v-btn class="d-flex align-center justify-center"
            ...
            block @click="goToCadastro">
            Cadastrar
          </v-btn>
        </v-col>
        <v-col> <v-btn class="d-flex align-center justify-center"
            style="background-color: cornflowerblue; color: white; width: 48%; font-size: 18px; padding: 12px; height: 50px;"
